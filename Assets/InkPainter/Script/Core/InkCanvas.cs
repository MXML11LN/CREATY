...
namespace Es.InkPainter
{
    ...
    public class InkCanvas : MonoBehaviour
    {
        ...
        public RenderTexture debugEraserMainView;
        public RenderTexture debugEraserNormalView;
        public RenderTexture debugEraserHeightView;
#pragma warning disable 0649
        public bool eraserDebug;
#pragma warning restore 0649
        ...
        [SerializeField] public List<PaintSet> paintSet = null;
        ...
        private void SetMaterial()
        {
            if (paintMainMaterial == null)
                paintMainMaterial = new Material(Resources.Load<Material>("Materials/Es.InkPainter.PaintMain"));
            if (paintNormalMaterial == null)
                paintNormalMaterial = new Material(Resources.Load<Material>("Materials/Es.InkPainter.PaintNormal"));
            if (paintHeightMaterial == null)
                paintHeightMaterial = new Material(Resources.Load<Material>("Materials/Es.InkPainter.PaintHeight"));
        ...
        public bool EraseNearestTriangleSurface(Brush brush, Vector3 worldPos,
            Func<PaintSet, bool> materialSelector = null, UnityEngine.Camera renderCamera = null)
        {
            eraseFlag = true;
            return PaintNearestTriangleSurface(brush, worldPos, materialSelector, renderCamera);
        }
        ...
        {
            return paintSet[0].paintMainTexture;
        }
        ...
        private class InkCanvasInspectorExtension : Editor
        {
            ...
            {
                string path = EditorUtility.SaveFilePanel("Save to png", Application.dataPath,
